...
trait RDD[T] extends js.Object {
  ...
  /**
    ...
    * @return
    */
  def filter(v: T => Boolean, bindArgs: js.Array[T] = js.native): this.type = js.native
  ...
  /**
    ...
    */
  def subtract[U](other: RDD[U], numPartitions: Int = js.native, p: Partition = js.native): RDD[T] = js.native
